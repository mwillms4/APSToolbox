...
%
blkStruct.Name = sprintf('Aircraft Power Systems Toolbox\n');

%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'APST_Lib';
...
%
Browser(1).Library = 'APST_Lib';
Browser(1).Name    = 'Aircraft Power Systems Toolbox';
